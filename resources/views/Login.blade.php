        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h6 class="font-weight-light" align="center"><b>Silahkan Masuk Untuk Tahap Berikutnya</b></h6>
              <form class="pt-3" method="POST" action="{{ route('login') }}">
               @csrf
                ...
                <div class="mt-3">
                  <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="/beranda">Masuk</a>
                </div>
